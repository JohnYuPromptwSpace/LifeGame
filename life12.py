"""
v0.1.11
Optimized by using less multiplication
Added Menu and Manage System
"""
...
def main_game():
    ...
    while running:
        ...
        if mode == 0 and pause == False and minimap_fullscreen == False:
            if mouse_pos[0] > SCREEN_WIDTH - button_expand_width - 450 and mouse_pos[1] > SCREEN_HEIGHT - 250:
