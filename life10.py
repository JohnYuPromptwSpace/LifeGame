...
v0.0.52
Added more dialogs
Added sync to cell update funciton
Added Map save
Tested Conway patterns
Changed Map size and cell size
"""
...
fontS2 = pygame.font.SysFont('monospace', int(CELL_SIZE * 4.8), bold=True)
...
# main game screen
def main_game():
    global current_game_data, current_screen, display_FPS
        ...
        for event in pygame.event.get():
            if dialogs:
                ...
                if currDialog.handle_event(event) == True:
                    ...
                    save_map_data(current_map, current_game_data+1)
                    del currDialog
                    dialogs.clear()
                    running = False
...
def main_title():
    ...
    while running:
        ...
        lab_title_rect = lab_title.get_rect(center=(WIDTH // 2, HEIGHT // 6*3.4))
        quit_title_rect = lab_title.get_rect(center=(WIDTH // 2, HEIGHT // 6*3.65))
