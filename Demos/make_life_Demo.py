...
def draw_pattern_overlay(screen, pattern, center_x, center_y):
    ...
    for rel_x, rel_y in pattern:
        ...
        abs_y = center_y + rel_y
        if 0 <= abs_x < GRID_SIZE and 0 <= abs_y < GRID_SIZE:
            pygame.draw.rect(overlay_surf, TRANSPARENT_GREEN, (abs_x * CELL_SIZE, abs_y * CELL_SIZE, CELL_SIZE, CELL_SIZE))
...
while running:
    ...
    draw_pattern_overlay(screen, toad_pattern, overlay_x, overlay_y)
