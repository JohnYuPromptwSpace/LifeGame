"""
v0.0.21
Optimaized update method by using track numpy list with 0,1 instead of "in" operator
"""
...
def main_game():
    ...
    def update_track_cell():
        track_cell = np.zeros((WORLD_HEIGHT//GAME_CELL_SIZE, WORLD_WIDTH//GAME_CELL_SIZE))
