"""
v0.1.81
Added create life logic
Added more option to settings
"""
    ...
    while running:
        ...
        for event in pygame.event.get():
            if dialogs:
                ...
                other = False
                if scroll_bar_show and not minimap_fullscreen:
                    ...
                    if mode == 1:
                        if manage_buttons[0][0].collidepoint(event.pos) and not minimap_fullscreen:
                            ...
                            if manage_mode == 2:
                                ...
                                manage_mode = 2
                                selected = None
                    if scroll_bar_toggle.collidepoint(event.pos) and not minimap_fullscreen:
                        other = True
                        scroll_bar_show = not scroll_bar_show
                    if manage_mode == 1 and selected != None and mouse_pos[0] > 135 and not other and not minimap_fullscreen:
        ...
        # create life
        if manage_mode == 1 and selected != None and not minimap_fullscreen:
